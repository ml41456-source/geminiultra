# ===========================================================
# script_normalizer_v2_12n.py
# Screenplay Normalizer (VI/EN) → StoryGrid v2.12n
#
# Nâng cấp trọng điểm v2.12n (Bản vá lỗi hồi quy v2.12m):
#  (1) [FIX] Lỗi Hồi quy (Presence Pass): Logic "Presence pass"
#      (dòng 780) trong v2.12m dùng slug làm key, gây ra
#      xung đột merge (key 'gau_truc' ghi đè 'Gau Truc').
#      → Sửa: Dùng base_canonical_name (e.g., "Gấu Trúc")
#      làm key VÀ thêm "Name": bname vào entry.
#      → Fix lỗi MẤT HÀNH ĐỘNG P3 và SAI TÊN (Name: "gau_truc").
#  (2) [FIX] Lỗi Typo Màu (Gấu Trúc): Logic `seed_variants_from_text`
#      (dòng 699) gán "xanh" thành "xanh_la" (đúng ra là "xanh").
#      → Sửa: Ưu tiên check "xanh lá" TRƯỚC "xanh".
#  (3) [KEPT] Giữ logic v2.12m (Fix P3 Subject, P2 Overlap, QC).
# ===========================================================
