# ===========================================================
# script_normalizer_v2_12m.py
# Screenplay Normalizer (VI/EN) → StoryGrid v2.12m
#
# Nâng cấp trọng điểm v2.12m:
#  (1) [FIX] Lỗi P3 Subject Bleed (Cảnh 6): Logic 'last_subject'
#      trong `extract_characters` (dòng 760-775) được viết lại
#      để dùng subject của CÂU TRƯỚC (current_last_subject_for_binding)
#      bind cho câu NÀY, TRƯỚC KHI cập nhật last_subject.
#      → Sửa lỗi "act_look" gán cho Gấu Trúc/Vịt Con thay vì TNH.
#  (2) [FIX] Lỗi P2 Overlap (Cảnh 6): Logic P2-fallback (dòng 597)
#      thêm bước kiểm tra regex để BỎ QUA các ngoặc đã
#      được xử lý bởi P2-direct (dạng <NAME> (...)).
#  (3) [FIX] Khôi phục QC (Color Bleed): Thêm lại logic
#      (dòng 1025) cảnh báo khi nhân vật (không phải teacher)
#      có MÀU nhưng KHÔNG có GARMENT.
#  (4) [KEPT] Giữ logic v2.12l (Garment/Color neo trái, bỏ "khăn").
# ===========================================================
